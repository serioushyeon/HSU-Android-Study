...
//            }
    ...
    private fun inputDummySongs() {
        ...
        val song1 = Song("Magnetic", "아일릿(ILLIT)", 0, 200, false, false, "music_magnetic",
            R.drawable.img_album_exp3
        )
        val song2 = Song("Supernova", "에스파(aespa)", 0, 200, false, false, "music_supernova",
            R.drawable.song_supernova
        )
        val song3 = Song("Next Level", "에스파(aespa)", 0, 200, false, false, "music_next",
            R.drawable.img_album_next
        )
        val song4 = Song("소나기", "이클립스(Eclipse)", 0, 200, false, false, "music_sudden",
            R.drawable.song_eclipse
        )
        val song5 = Song("Run Run", "이클립스(Eclipse)", 0, 200, false, false, "music_magnetic",
            R.drawable.song_eclipse
        )
